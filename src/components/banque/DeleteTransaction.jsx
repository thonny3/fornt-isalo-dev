...
export default function DeleteTransaction() {
    ...
    const {dataTrans,setTrans,onclose,openDT,getAllBanqueTransaction,edit}=  useBanque()
  ...
  const deletePoste = () => {
    ...
    setIsLoading(true);
    Transaction.deleteTransactionBanque(edit)
      .then(() => {
        toast.success("banque a été supprimé !");
        setTrans((prevList) => prevList.filter((item) => item.id !== edit)); // Mise à jour locale
        getAllBanqueTransaction(); // Rechargement des données
        onclose();
      })
      .catch((error) => {
  ...
  return (
    <Modal open={openDT} onClose={onclose}>
