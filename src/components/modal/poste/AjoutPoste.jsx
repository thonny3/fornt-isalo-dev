        ...
        <form action="" method="post px-5">
          ...
          <div className="form-group mt-5">
            ...
            <textarea
              ...
              cols="30"
              rows="10"
              className="form-control w-full h-20 px-3"
          ...
          <div className="boutton mt-5 text-right">
            ...
            <button
  type="button"
  className={`text-white bg-[#9A4C1E] hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 dark:bg-[#9A4C1E] dark:hover:bg-[#9A4C1E] dark:focus:ring-[9A4C1E#] ml-2 inline-flex items-center justify-center ${
    isLoading ? "cursor-not-allowed" : ""
  }`}
  onClick={handleSubmit}
  disabled={isLoading}
  style={{ width: "150px" }} // Ajustez la largeur selon vos besoins
>
  {isLoading ? (
    <svg
      aria-hidden="true"
    ...
    <span>{edit ? "Modifier" : "Ajouter"}</span>
  )}
</button>
