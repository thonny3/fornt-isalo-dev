...
export default function TableTiko() {
  ...
  <thead>
    <tr className="bg-gray-100 text-sm text-gray-500 font-normal">
      ...
      <th className="px-4 py-2 border border-gray-300">Prix tiko</th>
