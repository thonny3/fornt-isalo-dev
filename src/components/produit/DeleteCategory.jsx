...
export default function DeleteCategory() {
    ...
    const {setListCategorie,openDelete,onclose} = useProduit()
    ...
    const deleteProducts = () => {
      ...
      Produit.deleteCategory(id.id)
        .then(() => {
          toast.success("Le produit  a été supprimé !");
          setListCategorie((prevList) => prevList.filter((item) => item.id !== id.id)); // Mettre à jour la liste localement
          onclose();
  ...
  return (
    ...
    <div className="modal-content mt-5">
      ...
      <div className="w-56">
        ...
        {id && id.nom
            ? `Êtes-vous sûr de vouloir supprimer ce catégorie ${id.nom} ?`
